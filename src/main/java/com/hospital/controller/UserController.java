...
public class UserController {
    ...
    public void menu(Scanner scanner) {
        while (true) {
            ...
            switch (choice) {
                case 1:
                    executor.submit(new AddUserTask(scanner));
                    break;
                case 2:
                    executor.submit(new ViewUserInfoTask(scanner));
                    break;
                case 3:
                    executor.submit(new ViewAllUsersTask());
                    break;
                case 4:
                    executor.shutdown();
                    return;
    ...
    private class ViewUserInfoTask implements Runnable {
        ...
        ViewUserInfoTask(Scanner scanner) {
            this.scanner = scanner;
        }
