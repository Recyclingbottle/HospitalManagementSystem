...
public class PatientManagement {
    ...
    private static void addPatient(Scanner scanner) {
        try {
            ...
            Doctor assignedDoctor = DoctorManagement.findDoctorByName(doctorName);
            if (assignedDoctor == null) {
                System.out.println("해당 이름의 의사가 없습니다.");
                return;
            }
            Patient patient = new Patient(name, age, contactInfo, assignedDoctor);
    ...
    public static void addPatient(String name, int age, String contactInfo, String doctorName) {
        Doctor assignedDoctor = DoctorManagement.findDoctorByName(doctorName);
        if (assignedDoctor == null) {
            throw new IllegalArgumentException("해당 이름의 의사가 없습니다.");
        }
        Patient patient = new Patient(name, age, contactInfo, assignedDoctor);
        patients.add(patient);
    }
    ...
    private static void updateMedicalHistory(Scanner scanner) {
        try {
            ...
            if (patient != null) {
                ...
                patient.updateMedicalHistory(record);
    ...
    private static void updateCurrentMedication(Scanner scanner) {
        try {
            ...
            if (patient != null) {
                ...
                patient.updateCurrentMedication(medication);
